...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white text-gray-800 font-sans text-center px-6" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <Link 
        href="/" 
        className="px-6 py-3 bg-red-600 border-2 border-red-700 hover:bg-red-700 hover:border-red-800 text-sm text-white rounded-full font-semibold transition-all shadow-lg hover:shadow-xl"
      >
        ← Go Home
      </Link>
    </div>
